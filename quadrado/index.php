...
<body>
    ...
    <b><a href="../index.php">Quadro</a><b>  |  <b><a href="../triangulo/index.php">Triangulo</a><b>  |  </b><a href="../retangulo/index.php">Retangulo</a><b>  |  </b><a href="../circulo/index.php">Circulo</a>
    <section>
        ...
        <?php if ($qeditando) { ?>
            <br>
            <div>
                <b>Área: <?php echo $qeditando->calcularArea(); ?> <?php echo $qeditando->getUn(); ?></b><br>
                <b>Perímetro: <?php echo $qeditando->calcularPerimetro(); ?> <?php echo $qeditando->getUn(); ?></b><br>
            </div>
        <?php } ?>
