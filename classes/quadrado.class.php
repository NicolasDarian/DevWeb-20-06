...
class Quadrado extends Forma{
     public function __construct($id, $lado, $cor, $un, $pquadro){
         parent::__construct($id, $lado, $cor, $un, $pquadro);
     }

     public function inserir(){
         $sql = 'INSERT INTO quadrado (lado, cor, un, id_quadro)
                      VALUES (:lado, :cor, :un , :id_quadro)';
